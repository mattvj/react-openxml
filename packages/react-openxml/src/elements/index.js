...
const blankDocument = 'UEsDBBQABgAIAAAAIQDfpNJsWgEAACAFAAATAAgCW0NvbnRlbnRfVHlwZXNdLnhtbCCiBAIooAAC' +
...
async function createElement(type, props, root) {
  let instance;

  switch (type.toUpperCase()) {
    case 'ROOT':
      instance = new openXml.OpenXmlPackage();
      await instance.openFromBase64(blankDocument);
      break;
    default: {
      instance = await new Element(root, props, type.toLowerCase());
    }
  }
